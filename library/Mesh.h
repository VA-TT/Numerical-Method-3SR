...
private:
  ...
  DynamicVector<std::pair<T, T>>
      m_nodes{}; // All node coordinates as (x, y) pairs
  DynamicVector<std::pair<T, T>>
      m_nodes_initial{}; // Initial configuration for reset
  DynamicVector<char>
      m_activeNodes{}; // Track which nodes contain Material Points
