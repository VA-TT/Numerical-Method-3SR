...
In order to calculate each element of stiffness matrix $\mathcal{K}_{ij} = EA \int_0^l  N_i N_j dx$. The numerical integration scheme is Gaussian quadrature (document distributed during the course) with 2 points, values referencing in \cref{GaussWeight}.
   \begin{equation}
