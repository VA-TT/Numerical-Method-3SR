...
\begin{equation}
  ...
  \end{equation}
\end{enumerate}
So in general form, the problem of the console could be written as follows:
  \begin{align}
...
This part just provided the main code. Full version could be download in this \href{https://github.com/VA-TT/Numerical-Method-3SR}{link}.
