...
The plotting is realized by \texttt{Asymptote} - a vector graphic language with cpp-liked commands. The whole purpose is to learn so any corrections and comments are highly appreciated.
